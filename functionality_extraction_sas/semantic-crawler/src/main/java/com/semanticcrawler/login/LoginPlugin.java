...
public class LoginPlugin implements OnUrlLoadPlugin {
  ...
  private boolean openLoginPage(
    ...
    for (String text : loginTexts) {
      ...
      try {
        ...
        System.out.println(
            "Login page opened through link: "
                + text);
      ...
      try {
        ...
        System.out.println(
            "Login page opened through button: "
                + text);
      ...
      try {
        ...
        System.out.println(
            "Login page opened through submit: "
                + text);
  ...
  private boolean isAuthenticated(
    ...
    try {
      ...
      System.out.println(
          "Authentication check page text:");
      ...
      if (pageText.contains("utente sconosciuto")
          || pageText.contains("unknown user")) {
  ...
  public void onUrlLoad(
    ...
    try {
      ...
      if (userField == null
        ...
        System.out.println(
            "Login form not found. Trying to open login page.");
        ...
        if (openLoginPage(driver)) {
          ...
          System.out.println(
              "Current URL after login page opening: "
                  + driver.getCurrentUrl());
     ...
     System.out.println(
    "Username inserted: "
        + userField.getAttribute("value"));

String passwordValue =
    passwordField.getAttribute("value");

System.out.println(
    "Password length inserted: "
        + (passwordValue != null
...
try {
  ...
  System.out.println(
      "Form submit failed, trying passwordField.submit()");
