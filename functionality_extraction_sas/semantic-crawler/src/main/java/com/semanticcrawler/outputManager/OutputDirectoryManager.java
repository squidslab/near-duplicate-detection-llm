...
public final class OutputDirectoryManager {
    ...
    public static String createOutputDirectory(String appName, SasType sasType) {

        /*
         * Create application directory
         */
        File appDirectory = new File("out/" + appName);
        ...
        File[] existingCrawls = appDirectory.listFiles();
            ...
            for (File file : existingCrawls) {
                ...
                if (name.startsWith("crawl-")) {
                    ...
                    try {
                        ...
                        int crawlNumber = Integer.parseInt(parts[1]);

                        if (crawlNumber >= nextCrawlNumber) {

                            nextCrawlNumber = crawlNumber + 1;
                        }
        ...
        System.out.println("OUTPUT_DIRECTORY=" + outputDirectory);
