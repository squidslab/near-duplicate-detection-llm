...
public final class CrawljaxConfigurationFactory {
  ...
  public static CrawljaxConfiguration build(
      CrawlConfig config,
    ...
    switch (config.getSasType()) {
      ...
      case FUNCTIONALITY_EXTRACTION:
        ...
        builder.setStateVertexFactory(
            new FunctionalityExtractionStateVertexFactory());

        System.out.println(
            "Functionality extraction SAS registered");
      ...
      case DHASH:
        ...
        builder.setStateVertexFactory(
            new DHashStateVertexFactory());

        System.out.println(
            "DHash visual SAS registered");
     ...
     * Form handling
     */
    builder.crawlRules().setFormFillMode(
        FormFillMode.RANDOM);
    ...
    builder
        .crawlRules()
        .clickElementsInRandomOrder(false);
